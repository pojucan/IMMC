...
# Considere (atribua) para pi o valor 3.14159. Dica: Ao utilizar a fórmula, 
# procure usar (4/3.0) ou (4.0/3), pois algumas linguagens (dentre elas o C++), 
# assumem que o resultado da divisão entre dois inteiros é outro inteiro.


# Entrada: O arquivo de entrada contém um valor de ponto flutuante 
# (dupla precisão), correspondente ao raio da esfera.
